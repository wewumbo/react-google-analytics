...
class Sidebar extends React.Component {
	...
	constructor(props) {
		...
		this.state = {
			...
			dropdownOpen: false,
			//bgimage: this.props.property.data.logo,
			bgimage:""
		};
			...
			<aside className="left-sidebar" id="sidebarbg" data-sidebarbg={this.props.settings.activeSidebarBg} onMouseEnter={this.expandLogo} onMouseLeave={this.expandLogo}>
				<div className="scroll-sidebar">
					<PerfectScrollbar className="sidebar-nav">
						...
						{/* Profile Dropdown */}
						{/*--------------------------------------------------------------------------------*/}
						<div className="user-profile" style={{backgroundImage: `url(${this.state.bgimage})`,backgroundRepeat: 'no-repeat',backgroundSize:'auto' }}>
							...
							<div className="profile-text hide-menu">
								<Dropdown isOpen={this.state.dropdownOpen} toggle={this.toggle}>
									<DropdownToggle caret>{ this.props.auth.user.name }</DropdownToggle>
									<DropdownMenu>
										<DropdownItem>
